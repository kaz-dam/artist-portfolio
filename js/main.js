(function(){
	...
	var Makeup = {
		...
		init: function( config ) {
			...
			var self= this,
				...
				this.firstAnimation = this.bezier(.42,0,.58,1, epsilon);
				this.secondAnimation = this.bezier(.42,0,1,1, epsilon);
		...
		galleryPictureAnim: function() {
			var counter = 0,
				self = this,
				bgWedding = [
					'images/wedding-big/wedding1.jpg',
					'images/wedding-big/wedding2.jpg',
					'images/wedding-big/wedding3.jpg'
				],
				bgFashion = [
					'images/fashion/fashion1.jpg',
				...
				bgContest = [
					'images/contest/contest1.jpg',
					'images/contest/contest2.jpg',
					'images/contest/contest3.jpg'
				];
		...
		sideMenuHide: function() {
			...
			if ( self.config.windowObj.width() > 1000 ) {
				self.config.windowObj.scroll(function() {
	...
	Makeup.init({
		...
		jobDescriptionArrow: $('div.icon-wrapper svg.arrow-2'),
